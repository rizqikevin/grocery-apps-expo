...
export default function SignInScreen() {
  ...
  return (
    <SafeAreaView
      ...
      edges={["top"]}
    >
      <View className="absolute w-56 h-56 rounded-full -left-16 top-12 bg-primary/80 dark:bg-background/40" />
      <View className="absolute right-[-74px] top-40 h-72 w-72 rounded-full bg-primary/70 dark:bg-background/35" />
      <View className="px-6 pt-4">
        <Text className="font-mono text-5xl font-extrabold tracking-tight text-center uppercase text-primary-foreground dark:text-foreground">
          GROCERY
        </Text>
      ...
      <View className="mt-10 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6">
        <View className="self-center px-3 py-1 rounded-3xl bg-secondary">
        ...
        <View className="mt-7">
          ...
          >
            <View className="items-center justify-center w-8 h-8 bg-white rounded-full">
              <Image
            ...
            <Text className="flex-1 ml-3 text-lg font-semibold text-card-foreground">
              {isGoogleClicked
                ? "Connecting Google..."
          ...
          >
            ...
            <Text className="flex-1 ml-3 text-lg font-semibold text-background">
              {isAppleClicked ? "Connecting Apple..." : "Continue with Apple"}
            </Text>
            <FontAwesome name="angle-right" size={18} color="#5f6e66" />
          </Pressable>
        </View>
        <Text className="mt-6 text-sm leading-6 text-center text-muted-foreground">
